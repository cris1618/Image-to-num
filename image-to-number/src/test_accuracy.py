...
file_path_pred = "/home/uycdcdycdgycdydc/Image-to-num/predictions.csv"

# Test accuracy
digits_accuracy = calculate_digit_level_accuracy(file_path_labels, file_path_pred, nrows=99)